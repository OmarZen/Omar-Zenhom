    ...
    <>
      ...
      <div className="app__footer-cards">
        <div className="app__footer-card ">
          ...
          <a href="mailto:omarwaleedzenhom2002@gmail.com" className="p-text">omarwaleedzenhom2002@gmail.com</a>
        </div>
        <div className="app__footer-card">
          <img src={images.mobile} alt="phone" />
          <a href="tel:+02 0115 524 0556" className="p-text">02 0115 524 0556</a>
        </div>
      </div>
      {!isFormSubmitted ? (
